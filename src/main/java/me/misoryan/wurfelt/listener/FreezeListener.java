...
public class FreezeListener implements Listener {
        ...
        if (FreezeCommand.freezeing.get(e.getPlayer().getName()) != null) {
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    itemMeta.setDisplayName(Objects.requireNonNull(Wurfelt.ins.getConfig().getString("freeze.title")).replaceAll("&", "§"));
    ...
    public void onDisconnect(final PlayerQuitEvent e) {
        if (FreezeCommand.freezeing.get(e.getPlayer().getName()) != null) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), Objects.requireNonNull(Wurfelt.ins.getConfig().getString("freeze.disconnect.command")).replace("[PLAYER]", e.getPlayer().getName()));
